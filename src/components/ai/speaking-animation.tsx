...
export const SpeakingAnimation = () => {
  return (
    <div className="loader">
      <div style={{ '--i': 1, '--inset': '44%' } as BoxStyle} className="box">
        <div className="logo">
      ...
      <div style={{'--i': 2, '--inset': '40%' } as BoxStyle} className="box" />
      <div style={{'--i': 3, '--inset': '36%' } as BoxStyle} className="box" />
      <div style={{'--i': 4, '--inset': '32%' } as BoxStyle} className="box" />
      <div style={{'--i': 5, '--inset': '28%' } as BoxStyle} className="box" />
      <div style={{'--i': 6, '--inset': '24%' } as BoxStyle} className="box" />
      <div style={{'--i': 7, '--inset': '20%' } as BoxStyle} className="box" />
      <div style={{'--i': 8, '--inset': '16%' } as BoxStyle} className="box" />
    </div>
  );
};
